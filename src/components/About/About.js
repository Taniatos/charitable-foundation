          ...
          <div className="col-md ">
            <div className="about-text">
              <p>
                ...
                потребуючим з прифронтових зон.
              </p>
            </div>
          </div>
          <div className="col-md">
            <div className="about-text">
              <p>
                Влітку 2023 року команда фонду збільшилась, що вплинуло на
                масштаби діяльності фонду. Зараз Благодійний фонд імені Андрія
                Квятковського має свої офісне та складське приміщення. Основним
                донору фонду є New Forest Group for Ukraine, британська
                організація, із якою фонд підписав меморандум про співпрацю.
              </p>
            </div>
          </div>
        </div>
